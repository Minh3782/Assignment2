...
namespace Assignment2
{
    public class Program
    {
        ...
        public static void Question2()
        {
            ...
            Console.WriteLine($"Sum:{a + b} , Difference: {a - b}");
        }
        ...
        {
            Console.WriteLine("Are you in question 5?");
        ...
        public static void Question7()
        {
            ...
            Console.WriteLine("$" +(adultTicket*adl + childrenTicket*c));
        }
    }
}
